	...
	<section class="project-content-wrap content-wrap light-yellow clearfix">
		<h1>Behind the Brutes
			<ul class="project-controls no-bullets clearfix">
				<li>
					<a href="epic-stories" class="project-prev-arrow" title="Epic stories"><i class="io io-left-arrow"></i><span class="visually-hidden">Previous</span></a>
				</li>
				<li>
				...
				<li>
					<a href="preventing-ebola" class="project-next-arrow" title="Preventing ebola"><i class="io io-right-arrow"></i><span class="visually-hidden">Next</span></a>
				</li>
			</ul>
		</h1>
